...
Function Copy-PnPLibrary
{
    ...
    $SourceConn = Connect-PnPOnline -URL $SourceSiteURL -ReturnConnection -Interactive
...
#Parameters
$SourceSiteURL = "https://msdx261755.sharepoint.com/sites/Retail"
$DestinationSiteURL = "https://msdx261755.sharepoint.com/sites/Test"
